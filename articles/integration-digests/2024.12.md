...
_Bump.sh has introduced an AsyncAPI 3.0 Cheat Sheet, which complements their OpenAPI cheat sheet, to enhance their API management knowledge base. The cheat sheet, available as a PDF and under a CC BY-NC-SA 4.0 license, provides essential resources for adopting AsyncAPI specifications and documentation practices, featuring examples in JSON Schema and Avro._
