...
![Good articles lost at each step, retired models against the candidate. The topic filter goes from 2 to 16 while every other step is unchanged.](../img/losses-by-step.svg)
...
![Rejections by reasoning effort, out of 198 articles. gpt-5.4-nano climbs from 30 to 55 at the relevance gate, gpt-5.6-luna stays flat at 66, 61 and 68 on the same step, and gpt-5.6-luna at the topic filter falls from 168 to 119.](../img/effort-ladders.svg)
